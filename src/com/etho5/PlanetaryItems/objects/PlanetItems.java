...
public enum PlanetItems {
    ...
    SECTITE(
            ...
            Arrays.asList("Little green flakes of magic and mystery.", ChatColor.DARK_GREEN + "Planet of origin: " + ChatColor.GREEN + "Carbocera"),
            "Carbocera",
            112),
    UNREFINED_CARBON(
    ...
    GLACIAL_CORE(
            ...
            Arrays.asList("Cold, cloudy, and shining like a star.", ChatColor.DARK_GREEN + "Planet of origin: " + ChatColor.GREEN + "Hothura"),
            "Hothura",
            116)
    ;
